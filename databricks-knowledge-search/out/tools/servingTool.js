    ...
    async invoke(options) {
        ...
        try {
            ...
            switch (p.operation ?? 'invoke') {
                case 'list':
                    result = await g.servingList();
                    break;
                case 'get':
                    result = await g.servingGet(p.endpoint);
                    break;
                case 'openapi':
                    result = await g.servingOpenapi(p.endpoint);
                    break;
                case 'invoke':
                default:
...
exports.ServingTool = ServingTool;
//# sourceMappingURL=servingTool.js.map